...
struct TableTennisAnimationView: View {
    ...
    var appColor: Color = Color(red: 0.75, green: 0.9, blue: 0)
            ...
            VStack {
                ...
                ZStack {
                    ...
                    Image(systemName: "tennis.racket")
                        ...
                        .foregroundColor(Color(red: 0.85, green: 1, blue: 0))
                    ...
                    Image(systemName: "tennis.racket")
                        ...
                        .offset(x: 70, y: movingRight ? -7 : 40)
                        .animation(.easeInOut(duration: 0.6), value: movingRight)

                    if showSparkles {
                        ForEach(0..<100, id: \.self) { index in
                            Circle()
                                .fill(Color(red: 0.85, green: 1, blue: 0))
    ...
    /// **Animates the paddles with a slight rotation back and forth**
    func startPaddleRotation() {
        Timer.scheduledTimer(withTimeInterval: 0.6, repeats: true) { timer in
            withAnimation(.easeInOut(duration: 0.5)) {
                paddleRotation = paddleRotation == -10 ? 10 : -10
            }
        }
    }
}
